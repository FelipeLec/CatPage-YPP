(function () {
    $(".main-banner.about-cats-page").css("background-image", "url('../assets/img/Main-Banner/" + Math.floor(Math.random() * 17 + 1) + ".jpg')")
    $(".main-banner.main-page").css("background-image", "url('./assets/img/Main-Banner/" + Math.floor(Math.random() * 17 + 1) + ".jpg')")
